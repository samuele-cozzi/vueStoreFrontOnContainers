...
namespace Ordering.API.Application.IntegrationEvents.EventHandling
{
    public class CheckoutIntegrationEventHandler : IIntegrationEventHandler<CheckoutIntegrationEvent>
    {
        ...
        private readonly ILogger<CheckoutIntegrationEventHandler> _logger;

        public CheckoutIntegrationEventHandler(
            IMediator mediator,
            ILogger<CheckoutIntegrationEventHandler> logger)
        {
        ...
        /// </param>
        /// <returns></returns>
        public async Task Handle(CheckoutIntegrationEvent @event)
        {
